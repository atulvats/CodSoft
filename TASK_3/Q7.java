        ...
        do {
            ...
            switch (choice) {
                ...
                case 2:
                    ...
                    System.out.println("Thank you! Your new balance is: $" + atm.checkBalance());
                    break;
                case 3:
                    ...
                    if (withdrawAmount <= atm.checkBalance()) {
                        ...
                        System.out.println("Transaction successful! Your remaining balance is: $" + atm.checkBalance());
                    } else {
                        System.out.println("Transaction failed: Insufficient funds. Please enter a smaller amount.");
                    }
                    break;
                case 4:
